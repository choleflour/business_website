...
var index = defineComponent({
  ...
  methods: {
    ...
    generate() {
      ...
      switch (this.tag) {
        case "canvas":
          (0, import_qrcode.toCanvas)(this.$el, value, options, (error) => {
            if (error) {
              throw error;
            }
            done();
          ...
          break;
        case "img":
          (0, import_qrcode.toDataURL)(value, options, (error, url) => {
            if (error) {
              throw error;
            }
            this.$el.src = url;
          ...
          break;
        case "svg":
          (0, import_qrcode.toString)(value, options, (error, string) => {
            if (error) {
              throw error;
            }
...
@chenfengyuan/vue-qrcode/dist/vue-qrcode.esm.js:
  (*! vue-qrcode v2.0.0 | (c) 2018-present Chen Fengyuan | MIT *)
*/
//# sourceMappingURL=@chenfengyuan_vue-qrcode.js.map
